...
else if($dopost=='save')
{
    ...
    $query = $addtable == 'dede_addonshop' ?  "INSERT INTO `{$addtable}`(aid,typeid,redirecturl,templet,userip{$inadd_f}) Values('$arcID','$typeid','$redirecturl','$templet','$useip'{$inadd_v})" : "INSERT INTO `{$addtable}`(aid,typeid,redirecturl,templet,userip,body{$inadd_f}) Values('$arcID','$typeid','$redirecturl','$templet','$useip','$body'{$inadd_v})";
